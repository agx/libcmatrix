...
void
cm_client_get_user_info_async (CmClient            *self,
                               const char          *user_id,
                               GCancellable        *cancellable,
                               GAsyncReadyCallback  callback,
                               gpointer             user_data)
{
  ...
  cm_net_send_json_async (self->cm_net, 1, NULL, uri, SOUP_METHOD_GET,
                          NULL, self->cancellable, get_user_info_cb, task);
}

gboolean
cm_client_get_user_info_finish (CmClient      *self,
                                char         **name,
                                char         **avatar_url,
                                GAsyncResult  *result,
                                GError       **error)
...
/**
 * cm_client_set_name_async:
 * @self: A #CmClient
 * @name: (nullable): The display name for the user
 ...
 * unset
 *
 * Finish the call with cm_client_set_name_finish()
 */
void
cm_client_set_name_async (CmClient            *self,
                          const char          *name,
                          GCancellable        *cancellable,
                          GAsyncReadyCallback  callback,
                          gpointer             user_data)
{
  ...
  uri = g_strdup_printf ("/_matrix/client/r0/profile/%s/displayname", self->user_id);
  cm_net_send_json_async (self->cm_net, 1, root, uri, SOUP_METHOD_PUT,
                          NULL, self->cancellable, set_name_cb, task);
}

/**
 * cm_client_set_name_finish:
 * @self: A #CmClient
 * @result: A #GAsyncResult
 * @error: A #GError
 *
 * Finish the call started with cm_client_set_name_async()
 *
 * Returns: %TRUE if setting name was a success.
 * %FALSE otherwise with @error set.
 */
gboolean
cm_client_set_name_finish (CmClient      *self,
                           GAsyncResult  *result,
                           GError       **error)
{
  g_return_val_if_fail (CM_IS_CLIENT (self), FALSE);
...
/* Use a #GFile? */
void
cm_client_set_user_avatar_async (CmClient            *self,
                                 GFile               *image_file,
                                 GCancellable        *cancellable,
                                 GAsyncReadyCallback  callback,
                                 gpointer             user_data)
  ...
  if (!image_file)
    {
      ...
      data = "{\"avatar_url\":\"\"}";
      uri = g_strdup_printf ("/_matrix/client/r0/profile/%s/avatar_url", self->user_id);
      cm_net_send_data_async (self->cm_net, 2, g_strdup (data), strlen (data),
...
gboolean
cm_client_set_user_avatar_finish (CmClient      *self,
                                  GAsyncResult  *result,
                                  GError       **error)
{
  g_return_val_if_fail (CM_IS_CLIENT (self), FALSE);
                 ...
                 gpointer      user_data)
{
  ...
  g_debug ("Getting 3pid, success: %d, user: %s", !error, self->user_id);
...
void
cm_client_get_3pid_async (CmClient            *self,
                          GCancellable        *cancellable,
                          GAsyncReadyCallback  callback,
                          gpointer             user_data)
{
  ...
  g_debug ("Getting 3pid of user '%s'", self->user_id);

  cm_net_send_json_async (self->cm_net, 1, NULL,
                          "/_matrix/client/r0/account/3pid", SOUP_METHOD_GET,
                          NULL, self->cancellable, api_get_3pid_cb, task);
}

gboolean
cm_client_get_3pid_finish (CmClient      *self,
                           GPtrArray    **emails,
                           GPtrArray    **phones,
                           GAsyncResult  *result,
                           GError       **error)
...
void
cm_client_delete_3pid_async (CmClient            *self,
                             const char          *value,
                             const char          *type,
                             GCancellable        *cancellable,
                             GAsyncReadyCallback  callback,
                             gpointer             user_data)
{
  ...
  cm_net_send_json_async (self->cm_net, 2, root,
                          "/_matrix/client/r0/account/3pid/delete", SOUP_METHOD_POST,
                          NULL, cancellable, delete_3pid_cb, task);
}

gboolean
cm_client_delete_3pid_finish (CmClient      *self,
                              GAsyncResult  *result,
                              GError       **error)
{
  g_return_val_if_fail (CM_IS_CLIENT (self), FALSE);
